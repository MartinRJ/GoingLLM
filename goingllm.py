...
def do_more_searches(searchresults, usertask, task_id):
    ...
    responsemessage = chatcompletion_with_timeout(system_prompt, f"{prompt}{json.dumps(searchresults)}", TEMPERATURE_MORE_SEARCHES, MAX_TOKENS_MORE_SEARCHES_LENGTH, task_id)
